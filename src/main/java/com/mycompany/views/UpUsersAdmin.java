...
*/
    ...
    private void InitStyles(com.mycompany.models.Users user) {
        title.putClientProperty("FlatLaf.styleClass", "h1");
        title.setForeground(Color.black);
        cbxRole.setSelectedIndex(user.getRole().equals("work") ? 0:1);
    ...
    private void initComponents() {
        ...
        cbxRole.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Trabajador", "Administrativo" }));
    ...
    private void buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonActionPerformed
        ...
        String dom = (String) cbxRole.getSelectedItem();
        ...
        if (contieneDominio(tel)) {
            ...
            List <com.mycompany.models.Users> list = null;
            try {
                list = dao.listarEmail(tel);
            } catch (Exception ex) {
                Logger.getLogger(UpUsersAdmin.class.getName()).log(Level.SEVERE, null, ex);
            }
                    com.mycompany.models.Users user1 = null;
                    for (int i = 0; i < list.size(); i++){
                        user1 = list.get(i);
                        if(user1.getName().equals(nombre) && user1.getName().equals(nombre) && user1.getName().equals(nombre) && user1.getDomicilio().equals(".")){
                    ...
                    user.setRole(cbxRole.getSelectedIndex() == 0 ? "work" : "admin");
    ...
    public void sendEmail() throws IOException {
        ...
        try {
            ...
            String htmlContent = "<h1 style='color: #0047AB;'>Reporte de la Biblioteca Trinity</h1>"
                    ...
                    + "<p>Este es el cogido de autentificacion para agregar su Usuario.</p>"
                    +"<p>"+message+"<p>"
