...
public class Admins extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btn_graphs = new javax.swing.JButton();
        btn_usersWorks = new javax.swing.JButton();
        ...
        menu.add(btn_users, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 270, 52));
        ...
        menu.add(btn_books, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 230, 270, 52));
        ...
        menu.add(btn_reports, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 270, 52));

        btn_graphs.setBackground(new java.awt.Color(21, 101, 192));
        btn_graphs.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btn_graphs.setForeground(new java.awt.Color(255, 255, 255));
        btn_graphs.setIcon(new javax.swing.ImageIcon(getClass().getResource("/file-chart.png"))); // NOI18N
        btn_graphs.setText("Generar Grafica");
        btn_graphs.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 13, 1, 1, new java.awt.Color(0, 0, 0)));
        btn_graphs.setBorderPainted(false);
        btn_graphs.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btn_graphs.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btn_graphs.setIconTextGap(13);
        btn_graphs.setInheritsPopupMenu(true);
        btn_graphs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_graphsActionPerformed(evt);
            }
        });
        menu.add(btn_graphs, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 570, 270, 52));

        btn_usersWorks.setBackground(new java.awt.Color(21, 101, 192));
        btn_usersWorks.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btn_usersWorks.setForeground(new java.awt.Color(255, 255, 255));
        btn_usersWorks.setIcon(new javax.swing.ImageIcon(getClass().getResource("/account-multiple.png"))); // NOI18N
        btn_usersWorks.setText("Trabajadores");
        btn_usersWorks.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 13, 1, 1, new java.awt.Color(0, 0, 0)));
        btn_usersWorks.setBorderPainted(false);
        btn_usersWorks.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btn_usersWorks.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        btn_usersWorks.setIconTextGap(13);
        btn_usersWorks.setInheritsPopupMenu(true);
        btn_usersWorks.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_usersWorksActionPerformed(evt);
            }
        });
        menu.add(btn_usersWorks, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, 270, 52));
    ...
    private void btn_usersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_usersActionPerformed
        ...
        ShowJPanel(new UsersAdminLendings());
    ...
    private void btn_graphsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_graphsActionPerformed
        try {
            // TODO add your handling code here:
            //this.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
            new LoanReportChart("\"Graficas de prestamos Biblioteca Trinity\"").setDefaultCloseOperation(this.DO_NOTHING_ON_CLOSE);
        } catch (Exception ex) {
            Logger.getLogger(Admins.class.getName()).log(Level.SEVERE, null, ex);
        }
        LoanReportChart.mostrarGrafica();
    }//GEN-LAST:event_btn_graphsActionPerformed

    private void btn_usersWorksActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_usersWorksActionPerformed
        // TODO add your handling code here:
        
        ShowJPanel(new UsersAdmin());
    }//GEN-LAST:event_btn_usersWorksActionPerformed
